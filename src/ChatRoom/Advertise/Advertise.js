...
const Advertise = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (currentUser) {
                ...
                if (userRole !== 'admin' && userRole !== 'advertise') {
    ...
    useEffect(() => {
        const chatRef = ref(database, 'advertise');
            ...
            return (
                <React.Fragment key={msg.id}>
                    ...
                    <div
                        className="message"
                        style={{
                            alignSelf: (userRole === 'advertise' && msg.userId === currentUser.uid) || (userRole === 'admin' && msg.userId === 'admin') ? 'flex-end' : 'flex-start',
                            backgroundColor: (userRole === 'advertise' && msg.userId === currentUser.uid) || (userRole === 'admin' && msg.userId === 'admin') ? '#d1eaf4' : '#f3f3f3',
                        }}
