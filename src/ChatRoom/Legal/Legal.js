...
const Legal = () => {
    ...
    useEffect(() => {
        const chatRef = ref(database, 'legal');
            ...
            return (
                <React.Fragment key={msg.id}>
                    ...
                    <div
                        className="message"
                        style={{
                            alignSelf: (userRole === 'legal' && msg.userId === currentUser.uid) || (userRole === 'admin' && msg.userId === 'admin') ? 'flex-end' : 'flex-start',
                            backgroundColor: (userRole === 'legal' && msg.userId === currentUser.uid) || (userRole === 'admin' && msg.userId === 'admin') ? '#d1eaf4' : '#f3f3f3',
                        }}
