...
const Marketing = () => {
    ...
    useEffect(() => {
        const chatRef = ref(database, 'marketing');
            ...
            return (
                <React.Fragment key={msg.id}>
                    ...
                    <div
                        className="message"
                        style={{
                            alignSelf: (userRole === 'marketing' && msg.userId === currentUser.uid) || (userRole === 'admin' && msg.userId === 'admin') ? 'flex-end' : 'flex-start',
                            backgroundColor: (userRole === 'marketing' && msg.userId === currentUser.uid) || (userRole === 'admin' && msg.userId === 'admin') ? '#d1eaf4' : '#f3f3f3',
                        }}
